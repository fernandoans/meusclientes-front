...
function AddCliente() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        // Verifique se há conteúdo na resposta antes de tentar convertê-lo em JSON
  ...
  return (
    <div className="container mt-4">
      <h2 className="mb-4 text-center">Adicionar Cliente</h2>
      ...
      <form onSubmit={handleSubmit} className="container mt-5">
        ...
        <button type="submit" className="btn btn-success">Adicionar Cliente</button>
      </form>
    </div>
  );
}
